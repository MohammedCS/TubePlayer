namespace Maui.Apps.Framwork.Services; // namespace to orginze types and objects

/// <summary>
/// public : access modifier no restrictions on accessing public members
/// class  : reference type used to orginze the data and objects
/// </summary>
